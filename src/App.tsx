...
export default function App() {
  const primaryPhone = "1-855-OUTLAW6";
  const numericPhone = "1-855-688-5296";
  const phoneLink = "tel:+18556885296";
    ...
    <div className="min-h-screen font-body selection:bg-outlaw-accent selection:text-white flex flex-col bg-[#050505]">
      ...
      <header className="bg-black/60 backdrop-blur-2xl sticky top-0 z-50 border-b border-white/10 shadow-[0_4px_30px_rgba(0,0,0,0.5)] transition-all duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-24 md:h-28 flex items-center justify-between">
          ...
          <a
            href={phoneLink}
            className="group relative bg-transparent text-white px-6 py-3 md:px-8 md:py-3.5 rounded-none flex items-center gap-4 font-heading text-lg md:text-xl uppercase tracking-widest transition-all overflow-hidden border border-white/20 hover:border-outlaw-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-outlaw-accent focus-visible:ring-offset-2 focus-visible:ring-offset-black"
          >
            {/* Button Hover Fill */}
            ...
            <div className="relative z-10 flex items-center gap-3">
              ...
              <div className="flex flex-col items-start leading-none">
                ...
                <span className="group-hover:text-black transition-colors duration-500 hidden sm:block whitespace-nowrap">{primaryPhone}</span>
                <span className="text-gray-400 text-[10px] group-hover:text-black/70 font-body hidden md:block">{numericPhone}</span>
      ...
      <section className="relative bg-[#050505] pt-6 pb-48 lg:pt-32 lg:pb-64 overflow-hidden">
            ...
            <div className="max-w-2xl relative">
              <div className="flex items-center gap-4 mb-8">
                <div className="relative flex items-center justify-center w-6 h-6 rounded-full border border-outlaw-accent/30 bg-outlaw-accent/5">
                  <span className="absolute w-full h-full rounded-full border border-outlaw-accent opacity-20 motion-safe:animate-ping"></span>
                  <span className="w-1.5 h-1.5 bg-outlaw-accent rounded-full motion-safe:animate-pulse blur-[0.5px]"></span>
              ...
              <h1 className="text-6xl md:text-7xl lg:text-[5.5rem] font-heading text-white mb-8 leading-[0.9] tracking-tight uppercase">
                Let's get the <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-outlaw-accent to-yellow-300 filter drop-shadow-[0_0_20px_rgba(245,179,1,0.3)]">tow truck</span> moving.
              </h1>
              ...
              <div className="flex flex-wrap gap-5">
                <a href="#book" className="group relative bg-outlaw-accent text-black px-8 py-5 flex items-center gap-3 font-heading text-xl uppercase tracking-widest transition-all hover:bg-yellow-400 shadow-[0_0_30px_rgba(245,179,1,0.2)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[#050505]">
                  Request a Tow
                  <ChevronRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                </a>
                <a href="#services" className="bg-transparent border border-white/20 text-white hover:border-white hover:bg-white/5 px-8 py-5 flex items-center font-heading text-xl uppercase tracking-widest transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[#050505]">
                  Our Services
                </a>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 -mt-32 lg:-mt-40 mb-16" id="book">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-0 shadow-2xl rounded-lg overflow-hidden flex-col lg:flex-row">
          ...
          <div className="lg:col-span-2 bg-white p-8 md:p-10 border-t-4 border-outlaw-bg">
            ...
            <form className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input type="text" className="w-full border border-gray-300 rounded px-4 py-3 focus:outline-none focus-visible:ring-2 focus-visible:ring-outlaw-accent focus-visible:border-outlaw-accent" placeholder="John Doe" />
              </div>
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-1">Phone Number</label>
                <input type="tel" className="w-full border border-gray-300 rounded px-4 py-3 focus:outline-none focus-visible:ring-2 focus-visible:ring-outlaw-accent focus-visible:border-outlaw-accent" placeholder="(775) 555-0000" />
              </div>
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-1">Vehicle Location</label>
                <input type="text" className="w-full border border-gray-300 rounded px-4 py-3 focus:outline-none focus-visible:ring-2 focus-visible:ring-outlaw-accent focus-visible:border-outlaw-accent" placeholder="e.g., I-80 Eastbound MM 12" />
              </div>
              <div className="flex items-end">
                <button type="button" className="w-full bg-outlaw-bg hover:bg-gray-900 text-white font-heading text-lg uppercase tracking-wider py-3 px-4 rounded transition-colors flex justify-center items-center gap-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-outlaw-accent focus-visible:ring-offset-2 focus-visible:ring-offset-white">
          ...
          <div className="bg-outlaw-accent p-8 md:p-10 flex flex-col justify-center items-center text-center text-gray-900 border-t-4 border-outlaw-accent-hover">
            ...
            <a href={phoneLink} className="text-3xl lg:text-4xl font-heading font-bold hover:scale-105 transition-transform hover:text-outlaw-accent-hover whitespace-nowrap focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-900 focus-visible:ring-offset-2 focus-visible:ring-offset-outlaw-accent rounded-sm">
              {primaryPhone}
            </a>
            <a href={phoneLink} className="text-gray-800 font-bold hover:underline mt-1 text-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-900 focus-visible:ring-offset-2 focus-visible:ring-offset-outlaw-accent rounded-sm">
              {numericPhone}
            </a>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-6 relative">
              ...
              <div className="absolute -bottom-8 -right-4 md:-bottom-12 md:-right-8 bg-gray-900/90 backdrop-blur-md p-6 shadow-2xl rounded-xl border border-white/10 max-w-[220px] transform motion-safe:group-hover:-translate-y-2 transition-transform duration-500">
                <div className="flex items-center gap-4 mb-2">
                  <span className="w-3 h-3 bg-red-500 rounded-full motion-safe:animate-pulse"></span>
            ...
            <div className="lg:col-span-6 lg:pl-10">
              ...
              <a href="#services" className="inline-flex items-center gap-3 text-outlaw-accent font-heading text-lg uppercase tracking-widest hover:text-yellow-400 transition-colors group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-outlaw-accent focus-visible:ring-offset-2 focus-visible:ring-offset-[#0a0a0a] rounded-sm">
                Discover More
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div className="group relative bg-[#111111] border border-white/10 rounded-2xl overflow-hidden hover:border-outlaw-accent/50 transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_40px_-15px_rgba(204,85,0,0.3)] flex flex-col">
              <div className="absolute -top-10 -right-10 opacity-[0.03] group-hover:opacity-[0.08] transition-opacity duration-500 pointer-events-none transform motion-safe:group-hover:rotate-12 motion-safe:group-hover:scale-110">
                <Truck className="w-64 h-64 text-white" strokeWidth={1} />
              </div>

              <div className="p-8 lg:p-10 flex-grow flex flex-col relative z-10">
                <div className="w-20 h-20 rounded-3xl overflow-hidden mb-8 shadow-[0_0_20px_rgba(245,179,1,0.2)] motion-safe:group-hover:scale-110 transition-transform duration-500 border border-white/10 bg-black flex items-center justify-center p-1 relative group-hover:shadow-[0_0_30px_rgba(245,179,1,0.4)]">
      ...
      <section className="py-24 bg-[#050505] relative overflow-hidden border-t border-white/5" id="reviews">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-heading text-white mb-6 tracking-tight uppercase">Trusted by <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-outlaw-accent to-yellow-200">Nevadans</span></h2>
            <p className="text-gray-400 text-lg">Real reviews from drivers we've rescued from the worst conditions.</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            {/* Review 1 */}
            <div className="bg-[#111] border border-white/10 rounded-2xl p-8 hover:border-outlaw-accent/30 transition-colors flex flex-col">
              <div className="flex gap-1 mb-6">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} className="w-5 h-5 text-outlaw-accent fill-outlaw-accent" />
                ))}
              </div>
              <p className="text-gray-300 text-lg leading-relaxed flex-grow italic mb-8">
                "Saved our family on Donner Pass in a whiteout blizzard. They had the heavy gear to pull us out of a snowbank when two other companies said they couldn't make it. Literal lifesavers."
              </p>
              <div className="flex items-center gap-4 mt-auto">
                <div className="w-12 h-12 bg-gray-800 rounded-full flex items-center justify-center border border-white/20">
                  <span className="font-heading text-white text-xl">M</span>
                </div>
                <div>
                  <h4 className="text-white font-bold uppercase tracking-wider text-sm">Mike T.</h4>
                  <span className="text-gray-500 text-xs uppercase tracking-widest flex items-center gap-1"><CheckCircle2 className="w-3 h-3 text-green-500" /> Verified Rescue</span>
                </div>
              </div>
            </div>

            {/* Review 2 */}
            <div className="bg-[#0a0a0a] md:-translate-y-4 border border-outlaw-accent/20 rounded-2xl p-8 shadow-[0_10px_40px_-15px_rgba(245,179,1,0.15)] flex flex-col relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-outlaw-accent/10 rounded-bl-full pointer-events-none blur-3xl"></div>
              <div className="flex gap-1 mb-6">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} className="w-5 h-5 text-outlaw-accent fill-outlaw-accent" />
                ))}
              </div>
              <p className="text-gray-300 text-lg leading-relaxed flex-grow italic mb-8 relative z-10">
                "My transmission dropped going out to Pyramid Lake. It's miles from anywhere. American Outlaw showed up fast, charged exactly what dispatch quoted, and got my truck back to Sparks safely."
              </p>
              <div className="flex items-center gap-4 mt-auto relative z-10">
                <div className="w-12 h-12 bg-outlaw-accent/10 rounded-full flex items-center justify-center border border-outlaw-accent/50">
                  <span className="font-heading text-outlaw-accent text-xl">S</span>
                </div>
                <div>
                  <h4 className="text-white font-bold uppercase tracking-wider text-sm">Sarah R.</h4>
                  <span className="text-gray-500 text-xs uppercase tracking-widest flex items-center gap-1"><CheckCircle2 className="w-3 h-3 text-green-500" /> Verified Rescue</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#111] border border-white/10 rounded-2xl p-8 hover:border-outlaw-accent/30 transition-colors flex flex-col">
              ...
              <p className="text-gray-300 text-lg leading-relaxed flex-grow italic mb-8">
                "We use these guys for our commercial fleet. Best heavy recovery team in Northern Nevada, period. Fast response times and they actually know how to handle big rigs without causing damage."
              </p>
              <div className="flex items-center gap-4 mt-auto">
                <div className="w-12 h-12 bg-gray-800 rounded-full flex items-center justify-center border border-white/20">
                  <span className="font-heading text-white text-xl">B</span>
                </div>
                <div>
                  <h4 className="text-white font-bold uppercase tracking-wider text-sm">Brad W.</h4>
                  <span className="text-gray-500 text-xs uppercase tracking-widest flex items-center gap-1"><CheckCircle2 className="w-3 h-3 text-green-500" /> Commercial Account</span>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* FAQ Section */}
      <section className="py-24 bg-[#0a0a0a] relative overflow-hidden border-t border-white/5" id="faq">
        {/* Subtle Background Netting */}
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <div className="flex items-center justify-center gap-3 mb-4">
              <div className="w-12 h-[2px] bg-outlaw-accent/60"></div>
              <h4 className="text-outlaw-accent font-bold tracking-widest uppercase text-sm">No Surprises</h4>
              <div className="w-12 h-[2px] bg-outlaw-accent/60"></div>
            </div>
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-heading text-white mb-6 tracking-tight uppercase">Common <br /> <span className="text-outlaw-accent">Questions</span></h2>
          </div>

          <div className="space-y-4">
            {/* FAQ 1 */}
            <details className="group bg-[#111] border border-white/10 rounded-xl overflow-hidden focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-outlaw-accent focus-visible:ring-offset-2 focus-visible:ring-offset-[#0a0a0a] marker:content-['']">
              <summary className="p-6 md:p-8 font-heading text-xl text-white uppercase tracking-wide cursor-pointer list-none flex justify-between items-center hover:text-outlaw-accent hover:bg-white/5 transition-colors select-none">
                How fast can you arrive?
                <ChevronRight className="w-6 h-6 transform group-open:rotate-90 transition-transform duration-300 text-outlaw-accent flex-shrink-0 ml-4" />
              </summary>
              <div className="px-6 md:px-8 pb-8 text-gray-400 text-lg leading-relaxed border-t border-white/5 pt-6 bg-black/50">
                Our average ETA in the Greater Reno/Sparks area is 30-45 minutes. For Donner Pass or deeper high-desert recoveries, dispatch will give you a precise, live ETA based on current traffic and severe weather conditions.
              </div>
            </details>
            ...
            <details className="group bg-[#111] border border-white/10 rounded-xl overflow-hidden focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-outlaw-accent focus-visible:ring-offset-2 focus-visible:ring-offset-[#0a0a0a] marker:content-['']">
              <summary className="p-6 md:p-8 font-heading text-xl text-white uppercase tracking-wide cursor-pointer list-none flex justify-between items-center hover:text-outlaw-accent hover:bg-white/5 transition-colors select-none">
                Do you handle off-road recoveries?
                <ChevronRight className="w-6 h-6 transform group-open:rotate-90 transition-transform duration-300 text-outlaw-accent flex-shrink-0 ml-4" />
              </summary>
              <div className="px-6 md:px-8 pb-8 text-gray-400 text-lg leading-relaxed border-t border-white/5 pt-6 bg-black/50">
                Yes. We run specialized 4x4 wreckers built specifically for sand, mud, and ditch extraction on BLM land. If you got it stuck, we have the gear required to drag it out safely without further damage.
              </div>
            </details>
            ...
            <details className="group bg-[#111] border border-white/10 rounded-xl overflow-hidden focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-outlaw-accent focus-visible:ring-offset-2 focus-visible:ring-offset-[#0a0a0a] marker:content-['']">
              ...
              <div className="px-6 md:px-8 pb-8 text-gray-400 text-lg leading-relaxed border-t border-white/5 pt-6 bg-black/50">
                We believe in up-front, honest pricing. The exact cost depends on your vehicle type, location, and the distance to the drop-off point. When you call dispatch, they will give you a transparent rate with absolutely no hidden hook-up surprises.
              </div>
            </details>
            ...
            <details className="group bg-[#111] border border-white/10 rounded-xl overflow-hidden focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-outlaw-accent focus-visible:ring-offset-2 focus-visible:ring-offset-[#0a0a0a] marker:content-['']">
              ...
              <div className="px-6 md:px-8 pb-8 text-gray-400 text-lg leading-relaxed border-t border-white/5 pt-6 bg-black/50">
                100%. American Outlaw is fully licensed, bonded, and insured beyond Nevada minimum requirements for heavy commercial recovery. Your vehicle is completely covered from the moment we hook it up.
              </div>
            </details>
          </div>

          <div className="mt-12 text-center">
            <p className="text-gray-400 mb-6 font-medium">Have a different question?</p>
            <a href={phoneLink} className="inline-flex items-center gap-3 bg-white/5 border border-white/20 px-8 py-4 font-heading text-white uppercase tracking-widest hover:bg-white hover:text-black transition-colors rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-outlaw-accent focus-visible:ring-offset-2 focus-visible:ring-offset-[#0a0a0a]">
              Ask Dispatch Now
            </a>
          </div>
        </div>
      ...
      <section className="relative py-20 lg:py-24 overflow-hidden bg-gradient-to-r from-outlaw-accent via-yellow-400 to-outlaw-accent shadow-[0_-10px_40px_-5px_rgba(245,179,1,0.3)]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="relative group shrink-0">
            ...
            <a
              href={phoneLink}
              className="relative bg-gray-900 hover:bg-black text-white px-8 md:px-12 py-5 md:py-6 rounded-xl flex items-center gap-5 font-heading text-2xl md:text-3xl uppercase tracking-widest transition-all duration-300 transform motion-safe:group-hover:-translate-y-1 shadow-[0_20px_40px_-15px_rgba(0,0,0,0.5)] border border-gray-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-900 focus-visible:ring-offset-2 focus-visible:ring-offset-outlaw-accent"
            >
              <div className="relative flex items-center justify-center">
                <div className="absolute inset-[-10px] bg-outlaw-accent rounded-full motion-safe:animate-ping opacity-20"></div>
              ...
              <div className="flex flex-col items-start leading-none gap-1">
                ...
                <span className="text-gray-400 font-body font-bold text-sm tracking-widest">{numericPhone}</span>
              </div>
            </a>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            <div className="col-span-1 md:col-span-2">
              ...
              <div className="flex gap-4">
                <a href="#" className="w-12 h-12 bg-white/5 border border-white/10 rounded-full flex items-center justify-center hover:bg-outlaw-accent hover:border-outlaw-accent transition-colors cursor-pointer group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-outlaw-accent focus-visible:ring-offset-2 focus-visible:ring-offset-[#050505]" aria-label="Facebook">
                  <span className="font-bold text-gray-500 group-hover:text-black transition-colors">f</span>
                </a>
                <a href="#" className="w-12 h-12 bg-white/5 border border-white/10 rounded-full flex items-center justify-center hover:bg-outlaw-accent hover:border-outlaw-accent transition-colors cursor-pointer group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-outlaw-accent focus-visible:ring-offset-2 focus-visible:ring-offset-[#050505]" aria-label="Instagram">
              ...
              <ul className="space-y-6">
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href={phoneLink} className="block text-gray-300 hover:text-outlaw-accent transition-colors font-heading text-xl tracking-wider select-all">{primaryPhone}</a>
                    <a href={phoneLink} className="block text-gray-500 hover:text-outlaw-accent transition-colors font-body text-sm tracking-wider select-all mt-1">{numericPhone}</a>
                  </div>
                </li>
                <li className="flex items-start gap-4">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><a href="#" className="text-gray-500 hover:text-outlaw-accent transition-colors flex items-center gap-2 group w-fit focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-outlaw-accent focus-visible:ring-offset-2 focus-visible:ring-offset-[#050505] rounded-sm"><ChevronRight className="w-4 h-4 text-outlaw-accent/50 group-hover:text-outlaw-accent group-hover:translate-x-1 transition-all motion-reduce:transition-none" /> Reno</a></li>
                <li><a href="#" className="text-gray-500 hover:text-outlaw-accent transition-colors flex items-center gap-2 group w-fit focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-outlaw-accent focus-visible:ring-offset-2 focus-visible:ring-offset-[#050505] rounded-sm"><ChevronRight className="w-4 h-4 text-outlaw-accent/50 group-hover:text-outlaw-accent group-hover:translate-x-1 transition-all motion-reduce:transition-none" /> Sparks</a></li>
                <li><a href="#" className="text-gray-500 hover:text-outlaw-accent transition-colors flex items-center gap-2 group w-fit focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-outlaw-accent focus-visible:ring-offset-2 focus-visible:ring-offset-[#050505] rounded-sm"><ChevronRight className="w-4 h-4 text-outlaw-accent/50 group-hover:text-outlaw-accent group-hover:translate-x-1 transition-all motion-reduce:transition-none" /> Carson City</a></li>
                <li><a href="#" className="text-gray-500 hover:text-outlaw-accent transition-colors flex items-center gap-2 group w-fit focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-outlaw-accent focus-visible:ring-offset-2 focus-visible:ring-offset-[#050505] rounded-sm"><ChevronRight className="w-4 h-4 text-outlaw-accent/50 group-hover:text-outlaw-accent group-hover:translate-x-1 transition-all motion-reduce:transition-none" /> Truckee & Donner</a></li>
                <li><a href="#" className="text-gray-500 hover:text-outlaw-accent transition-colors flex items-center gap-2 group w-fit focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-outlaw-accent focus-visible:ring-offset-2 focus-visible:ring-offset-[#050505] rounded-sm"><ChevronRight className="w-4 h-4 text-outlaw-accent/50 group-hover:text-outlaw-accent group-hover:translate-x-1 transition-all motion-reduce:transition-none" /> Fernley</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-xs tracking-wider uppercase text-gray-600">
            ...
            <div className="flex gap-6">
              <a href="#" className="hover:text-outlaw-accent transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-outlaw-accent focus-visible:ring-offset-2 focus-visible:ring-offset-[#050505] rounded-sm">Privacy Policy</a>
              <a href="#" className="hover:text-outlaw-accent transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-outlaw-accent focus-visible:ring-offset-2 focus-visible:ring-offset-[#050505] rounded-sm">Terms of Service</a>
            </div>
          </div>
        </div>
      </footer>
